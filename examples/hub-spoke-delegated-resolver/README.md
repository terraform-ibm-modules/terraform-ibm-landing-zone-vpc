...
<p>
  <a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=landing-zone-vpc-hub-spoke-delegated-resolver-example&repository=https://github.com/terraform-ibm-modules/terraform-ibm-landing-zone-vpc/tree/main/examples/hub-spoke-delegated-resolver">
...
The full topology, including the delegated DNS resolver on the spoke VPC, is deployed in a **single** `terraform apply`. The `update_delegated_resolver` variable has been removed and is no longer required.

You may also be interested in the [Hub and Spoke VPC with manual DNS resolver Example](../hub-spoke-manual-resolver/).
