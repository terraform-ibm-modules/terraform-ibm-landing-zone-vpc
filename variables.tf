...
variable "resource_tags" {
  description = "Add user resource tags to the VPC resources to organize, track, and manage costs. [Learn more](https://cloud.ibm.com/docs/account?topic=account-tag&interface=ui#tag-types)."
  type        = list(string)
  default     = []
...
variable "access_tags" {
  type        = list(string)
  description = "Add access management tags to the VPC resources to control access. [Learn more](https://cloud.ibm.com/docs/account?topic=account-tag&interface=ui#create-access-console)."
  default     = []
