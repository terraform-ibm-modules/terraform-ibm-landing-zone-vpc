...
| <a name="input_name"></a> [name](#input\_name) | If `create_vpc` is true, this string names both the VPC and associated resources. If false, it names only the associated resources. | `string` | n/a | yes |
