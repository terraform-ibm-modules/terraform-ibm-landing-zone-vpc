...
| <a name="module_vpn_gateways"></a> [vpn\_gateways](#module\_vpn\_gateways) | terraform-ibm-modules/site-to-site-vpn/ibm | 3.0.7 |
...
| <a name="input_use_public_gateways"></a> [use\_public\_gateways](#input\_use\_public\_gateways) | Create a public gateway in any of the three zones with `true`. | <pre>object({<br/>    zone-1 = optional(bool, false)<br/>    zone-2 = optional(bool, false)<br/>    zone-3 = optional(bool, false)<br/>  })</pre> | <pre>{<br/>  "zone-1": true,<br/>  "zone-2": true,<br/>  "zone-3": true<br/>}</pre> | no |
