...
| <a name="input_name"></a> [name](#input\_name) | The string to use for the naming of VPC, when var.create\_vpc is true. This string also use for the naming of VPC resources. | `string` | `"dev"` | no |
